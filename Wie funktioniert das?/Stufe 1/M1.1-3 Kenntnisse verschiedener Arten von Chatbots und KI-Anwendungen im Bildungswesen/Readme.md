# Kenntnisse verschiedener Arten von Chatbots und KI-Anwendungen im Bildungswesen
Angebotskennung: M1.1-3
...
Kurzbeschreibung Dieser Kurs bietet einen kompakten und praxisorientierten Einstieg in zentrale KI-Anwendungen im schulischen Kontext. Im Mittelpunkt stehen Chatbots, sowohl regelbasierte als auch KI-gestützte, sowie KI-basierte Lernplattformen, die individuelles Lernen unterstützen und Verwaltungsprozesse entlasten können. Anhand konkreter Anwendungsbeispiele aus Unterricht und Schulorganisation erfahren Sie, wie diese Technologien funktionieren und wo ihre Einsatzpotenziale und Grenzen liegen.

**Inhalte**

Das Lernangebot behandelt die folgenden zentralen Themenbereiche:

* Vorstellung verschiedener Typen von Chatbots, z.B. regelbasierte vs. KI-basierte Chatbots.
* Grundprinzipien adaptiver Lernplattformen.
* Typische Einsatzszenarien in Schule, Unterricht und Verwaltung.
* Einschätzung von Chancen und Risiken des KI-Einsatzes.
* Entwicklung erster Ideen für den eigenen professionellen Einsatz.

**Lernziele**

Aufzeigen der Bandbreite an KI-Anwendungen und spezifischen Chatbots im Bildungskontext.
...
Das Angebot richtet sich an Mitarbeitende von Behörden im Geschäftsbereich des Kultusministeriums (Lehrkräfte, schulisches Leitungspersonal, leitungsunterstützendes Personal, Bildungsadministratorinnen und -administratoren). Dieser Kurs richtet sich an alle, die in Schule und Schulverwaltung tätig sind, unabhängig von Fach, Schulform oder Funktion.
