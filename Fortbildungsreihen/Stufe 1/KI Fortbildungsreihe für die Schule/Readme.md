# KI Fortbildungsreihe für die Schule (Kompetenzstufe 1)
Angebotskennung: R1
## Inhaltiche Gestaltung

Diese Fortbilsungsreihe ist Teil des Programms „KI verstehen. Zukunft gestalten“. Es handelt sich um einen Selbstlernkurs, der nach der Anmeldung unmittelbar verfügbar ist und direkt bearbeitet werden kann. Die geschätzte Bearbeitungszeit beträgt maximal ca. 8 Stunden in acht Schritten je 60 Minuten. Der Kurs wird auf Moodle bereitgestellt und kann selbstgesteuert in Ihrem eigenen Tempo bearbeitet werden. Sie erwartet ein abwechslungsreicher Mix aus Videos, Lesetexten und Audiodateien, der unterschiedliche Lernzugänge ermöglicht.

**Kurzbeschreibung**

Diese Fortbildungsreihe bietet einen umfassenden Einstieg in das Thema Künstliche Intelligenz (KI) und beleuchtet es aus den drei Perspektiven Funktionsweise, Anwendung und Wirkung. Teilnehmende erlangen ein fundiertes Verständnis darüber, wie KI-Systeme arbeiten, und setzen sich intensiv mit den rechtlichen Rahmenbedingungen wie Datenschutz und Urheberrecht auseinander. Darauf aufbauend werden praktische Kompetenzen im Bereich Prompting und Textgenerierung vermittelt. Abschließend fokussiert die Reihe auf die ethische Reflexion von Chancen und Risiken sowie die gesellschaftlichen Auswirkungen des KI-Einsatzes in Schule und Verwaltung.

**Inhalte**

Das Lernangebot behandelt die folgenden zentralen Themenbereiche:

* Grundlagen und Begriffe der KI: Funktionsweise, maschinelles Lernen und Datenverarbeitung.
* Rechtliche Rahmenbedingungen: Datenschutz (DSGVO, AI Act) und Urheberrecht beim Einsatz von KI.
* Praktische Anwendung: Einführung in das Prompting und Strategien zur Textgenerierung.
* Integration von KI-Tools in den Arbeitsalltag von Schule und Verwaltung durch praktische Übungen.
* Ethik und Verantwortung: Identifikation von Chancen, Risiken und Bias in KI-Systemen.
* Analyse des Wechselverhältnisses von Technologie und Gesellschaft sowie Reflexion der eigenen Haltung.

**Lernziele**

Die Teilnehmenden erwerben eine umfassende Handlungskompetenz im Umgang mit Künstlicher Intelligenz (KI) auf Kompetenzstufe 1. Sie entwickeln ein fundiertes Verständnis für die technologischen Grundlagen und Funktionsweisen von KI-Systemen und sind in der Lage, KI-Tools durch effektives Prompting praxisnah und zielgerichtet in den Arbeitsalltag von Schule und Verwaltung zu integrieren. Dabei lernen sie, den Einsatz dieser Technologien unter strikter Berücksichtigung von Datenschutz, Urheberrecht und ethischen Prinzipien sicher zu gestalten und kritisch zu reflektieren.

**Format**

Dies ist ein Online-Selbstlernkurs. Nach der Anmeldung steht Ihnen das Angebot sofort zur Verfügung und kann direkt bearbeitet werden. Die geschätzte Bearbeitungszeit beträgt maximal ca. 8 Stunden in acht Schritten je 60 Minuten. Sollten Sie Schwierigkeiten haben, den Kurs zu finden, hilft Ihnen diese kurze Anleitung weiter: 👉 [Zur Anleitung](https://nlc.info/app/edb/help/ELECMoodleKurs113)
...
Keine spezifischen Vorkenntnisse erforderlich; grundlegende Computerkenntnisse sind hilfreich.

## Kombinierte Lernangebote
...
* M1-1-6 Einführung-Urheberrecht
* M2-1-1 Prompting und Textgenerierung
* M2-1-2 Praktische Übungen
...
**[Direkt zum Kurs im NLC](https://nlc.info/app/edb/event/51569)**
